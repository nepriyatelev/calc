...
Во всех способах надо сначала перейти на страницу https://github.com/nepriyatelev/calc
...
Делаем клон репозитория https://github.com/nepriyatelev/calc

Если установлен git

    git clone https://github.com/nepriyatelev/calc.git
